"""
Gym-style environment wrapper for Maze 2  (25x25).

Observation : flat float32 array of shape (625,)
    0.0 = floor,  1.0 = wall,  2.0 = player,  3.0 = exit
...
import numpy as np
import maze_2 as _map


# ---------------------------------------------------------------------------
# Maze 2 layout — sourced from maze_2.py (single source of truth)
# ---------------------------------------------------------------------------
...
class MazeEnv:
    ...
    def _observe(self) -> np.ndarray:
        """Return a flat float32 array of shape (625,) encoding the grid."""
